...
<body>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<h1>Draw Me!</h1>
				<p>Listen to the instructions performed by the other person. Draw what they tell you. You won't be able to see your work until it is finished.</p>
			</div>
		</div>
		<div class="row">
			<div class="col-md-12">
				...
				<canvas id="sig-canvas2" width="300" height="300" style="visibility:hidden">
		 			Get a better browser, bro.
		 		</canvas>
		 	</div>
		</div>
