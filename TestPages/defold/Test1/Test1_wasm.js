...
var wasmImports = {
  ...
  ec: _emscripten_websocket_delete,
  dc: _emscripten_websocket_new,
  cc: _emscripten_websocket_send_binary,
  bc: _emscripten_websocket_send_utf8_text,
  ac: _emscripten_websocket_set_onclose_callback_on_thread,
  $b: _emscripten_websocket_set_onerror_callback_on_thread,
  _b: _emscripten_websocket_set_onmessage_callback_on_thread,
  Zb: _emscripten_websocket_set_onopen_callback_on_thread,
  Dh: _environ_get,
  ...
  Ob: _glDepthMask,
  Nb: _glDisable,
  Mb: _glDisableVertexAttribArray,
  Lb: _glDrawArrays,
  Kb: _glDrawBuffers,
  Jb: _glDrawElements,
  Ib: _glEnable,
  ...
  Gb: _glFlush,
  Fb: _glFramebufferRenderbuffer,
  Eb: _glFramebufferTexture2D,
  Db: _glFrontFace,
  ka: _glGenBuffers,
  Cb: _glGenFramebuffers,
  A: _glGenRenderbuffers,
  ja: _glGenTextures,
  Bb: _glGetActiveAttrib,
  ...
  K: _glShaderSource,
  tb: _glStencilFunc,
  sb: _glStencilFuncSeparate,
  rb: _glStencilMask,
  qb: _glStencilOp,
  pb: _glStencilOpSeparate,
  i: _glTexImage2D,
  ob: _glTexImage3D,
  nb: _glTexParameterf,
  J: _glTexParameteri,
  ...
  hb: _glViewport,
  gb: _glfwAccelerometerEnable,
  fb: _glfwCloseWindow,
  eb: _glfwDisable,
  db: _glfwEnable,
  cb: _glfwGetAcceleration,
  ea: _glfwGetDefaultFramebuffer,
  bb: _glfwGetDisplayScaleFactor,
  ab: _glfwGetJoystickButtons,
  $a: _glfwGetJoystickDeviceId,
  _a: _glfwGetJoystickHats,
  I: _glfwGetJoystickParam,
  Za: _glfwGetJoystickPos,
  Ya: _glfwGetKey,
  h: _glfwGetMouseButton,
  Xa: _glfwGetMouseLocked,
  Wa: _glfwGetMousePos,
  Va: _glfwGetMouseWheel,
  Ua: _glfwGetWindowParam,
  Ta: _glfwGetWindowRefreshRate,
  da: _glfwGetWindowSize,
  Sa: _glfwIconifyWindow,
  Ra: _glfwInitJS,
  ca: _glfwOpenWindow,
  x: _glfwOpenWindowHint,
  Qa: _glfwPollEvents,
  Pa: _glfwResetKeyboard,
  Oa: _glfwSetCharCallback,
  Na: _glfwSetDeviceChangedCallback,
  Ma: _glfwSetGamepadCallback,
  La: _glfwSetMarkedTextCallback,
  Ka: _glfwSetTouchCallback,
  Ja: _glfwSetWindowBackgroundColor,
  Ia: _glfwSetWindowCloseCallback,
  Ha: _glfwSetWindowFocusCallback,
  Ga: _glfwSetWindowIconifyCallback,
  Fa: _glfwSetWindowSize,
  Ea: _glfwSetWindowSizeCallback,
  Da: _glfwSetWindowTitle,
  H: _glfwShowKeyboard,
  Ca: _glfwSwapBuffers,
...
var _free = Module["_free"] = function (a0) {
  return (_free = Module["_free"] = wasmExports["Yh"])(a0);
};
